...
namespace SimpleLibraryManagement.Application.Services
{
    public class BorrowedBookService : IBorrowedBookService
    {
        ...
        public async Task<ApiResponse<List<DisplayBorrowedBook>>> GetBorrowedBookByBorrowerIdAsync(int borrowerId)
        {
            ...
            return ApiResponse<List<DisplayBorrowedBook>>.SuccessResponse(true, StatusCodes.Status200OK, _mapper.Map<List<DisplayBorrowedBook>>(books));
        }

        public async Task<List<DisplayBorrowedBook>> GetBorrowedBooksAsync()
        {
            return _mapper.Map<List<DisplayBorrowedBook>>(await _borrowedBookRepository.GetDisplayBorrowedBooks()) ;
        }
